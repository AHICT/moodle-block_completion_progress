...
class overview_filter extends \core\output\datafilter {
     ...
     * @param int $blockinstanceid The completion progress block instance id.
     * @param string|null $tableregionid Container of the table which will be updated by this filter
     */
    public function __construct(context $context, int $blockinstanceid, ?string $tableregionid = null) {
